...
import by.kobyzau.tg.bot.pbot.handlers.command.handler.achievement.TopPidorAchievement;
...
public class TopPidorAchievementTest {
  ...
  @Before
  public void init() {
    this.achievement = new TopPidorAchievement(pidorService, dailyPidorRepository);
  }
  ...
  public void topPidor1() {
    ...
    assertEquals(
        new TextBuilder(
                new SimpleText("Чаще всего был пидором дня:"),
                new NewLineText(),
                new NewLineText(),
                new ParametizedText(
                    "{0} - был пидором {1} раз(а) (55%)",
                    new FullNamePidorText(getPidor(2)), new SimpleText(String.valueOf(5))))
