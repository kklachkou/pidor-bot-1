...
public class FullElectionStatPrinterTest extends BotActionAbstractTest {
  ...
  @Test
  public void printInfo_withoutCount_noZeros_withArtefact() {
    // given
    List<Pair<Integer, Integer>> pidorIdsAndVotes =
        Arrays.asList(new Pair<>(1, 1), new Pair<>(2, 4), new Pair<>(3, 2));
    LocalDate now = DateUtil.now();
  ...
  @Test
  public void printInfo_withoutCount_withZeros_withArtefact() {
    // given
    List<Pair<Integer, Integer>> pidorIdsAndVotes =
        Arrays.asList(new Pair<>(1, 0), new Pair<>(2, 4), new Pair<>(3, 2), new Pair<>(4, 0));
    LocalDate now = DateUtil.now();
  ...
  @Test
  public void printInfo_noVotes_withArtefact() {
    // given
    List<Pair<Integer, Integer>> pidorIdsAndVotes =
    ...
    doReturn(Optional.of(new UserArtifact()))
        .when(userArtifactService)
        .getUserArtifact(chatId, 2, ArtifactType.PIDOR_MAGNET, now);
